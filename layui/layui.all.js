    ...
    var e = window.layui && layui.define
      ...
      , n = {
        ...
        ready: function(a) {
            var i = "laydate"
              , r = ""
              , o = (e ? "modules/laydate/" : "theme/") + "default/laydate.css" + r;
                    ...
                    if (!u) {
                        ...
                        var $ = function(e, i, a) {
                            ...
                            layui.each(x, function() {
                                var i = t(this)
                                  , l = i.text().toLowerCase()
                                  , r = l.indexOf(e.toLowerCase()) === -1;
                                ("" === e || "blur" === a ? e !== l : r) && n++,
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    F.prototype.events = function() {
        ...
        i.layTool.on("click", "*[lay-event]", function(e) {
            ...
            j.trigger("table.tool.panel.remove"),
            l.close(i.tipsIndex),
            c) {
            case "LAYTABLE_COLS":
                s({
